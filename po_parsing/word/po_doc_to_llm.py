...
def build_word_prompt(text):
  prompt = f"""
YYou are an procurement specialist.
...
1. **Extract metadata** such as PO number, date, buyer information (company name, address, phone), supplier/vendor information (company name, contact person, address, email, phone).
